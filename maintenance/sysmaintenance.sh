...
# This file is stolen by me from https://github.com/kurealnum/dotfiles/blob/main/.config/scripts/sysmaintenance.sh.
# All rights reserved to him and the person he copied it from whose github profile is mentioned here --> https://github.com/android10
